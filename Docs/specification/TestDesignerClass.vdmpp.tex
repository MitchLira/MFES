...
\hline
\hline
\hyperref[testAddItem:24]{testAddItem} & 24&100.0\% & 3 \\
\hline
\hyperref[testAddItems:35]{testAddItems} & 35&100.0\% & 3 \\
\hline
\hyperref[testAll:74]{testAll} & 74&100.0\% & 3 \\
\hline
\hyperref[testRemItem:48]{testRemItem} & 48&100.0\% & 3 \\
\hline
\hyperref[testRemItems:59]{testRemItems} & 59&100.0\% & 3 \\
\hline
\hline
TestDesignerClass.vdmpp & & 100.0\% & 15 \\
\hline
\end{longtable}
